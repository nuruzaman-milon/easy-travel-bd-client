...
const Header = () => {
  ...
  return (
    <div className="bg-primary">
      <Navbar fluid={true} className="w-[92%] mx-auto !bg-primary">
              ...
              {dbUser?.accountType === "admin" && (
                <>
                  ...
                  <Dropdown.Item icon={FaUsersCog}>
                    <Link to="/allBusProviderList">All Bus Provider</Link>
                  </Dropdown.Item>
                </>
              )}
        ...
        <Navbar.Collapse className="flex items-center justify-center">
          ...
          <div className="flex items-center text-black text-center text-lg hover:text-black md:hover:text-white hover:underline underline-offset-2 mb-2 md:mb-0">
            <img
              ...
              src="https://i.ibb.co/wrSbyP0/info.png"
              alt=""
            />
          ...
          <div className="flex items-center text-black text-center text-lg hover:text-black md:hover:text-white hover:underline underline-offset-2 mb-2 md:mb-0">
            <img
              className="w-6 mr-1"
              src="https://i.ibb.co/3c5LrCH/handshake.png"
              alt=""
            />
          ...
          <div className="flex items-center text-black text-center text-lg hover:text-black md:hover:text-white hover:underline underline-offset-2 mb-2 md:mb-0">
            <img
              className="w-5 h-5 mr-1"
              src="https://i.ibb.co/cXHrFMB/analytic.png"
              alt=""
            />
          ...
          <div className="flex items-center text-black text-center text-lg hover:text-black md:hover:text-white hover:underline underline-offset-2 mb-2 md:mb-0">
            <img
              className="w-5 h-5 mr-1"
              src="https://i.ibb.co/ZXqNPLt/phone-call.png"
              alt=""
            />
          ...
          <div className="flex items-center text-black text-center text-lg hover:text-black md:hover:text-white hover:underline underline-offset-2 mb-2 md:mb-0">
            <img
              className="w-5 h-5"
              src="https://i.ibb.co/D4LKyqN/receipt.png"
              alt=""
            />
